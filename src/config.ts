...
const notifications = {
  ...
  discord: {
    ...
    notifyGroupSeries: {
      ...
      ryzen9600: envOrArray(process.env.DISCORD_NOTIFY_GROUP_RYZEN9600X),
      ryzen9700: envOrArray(process.env.DISCORD_NOTIFY_GROUP_RYZEN9700X),
      ryzen9900: envOrArray(process.env.DISCORD_NOTIFY_GROUP_RYZEN9900X),
      ryzen9950: envOrArray(process.env.DISCORD_NOTIFY_GROUP_RYZEN9950X),
...
const store = {
  ...
  maxPrice: {
    series: {
      ...
      ryzen9700: envOrNumber(process.env.MAX_PRICE_SERIES_RYZEN9700X),
