...
const notifications = {
  ...
  discord: {
    ...
    notifyGroupSeries: {
      ...
      ryzen7900x3d: envOrArray(process.env.DISCORD_NOTIFY_GROUP_RYZEN7900X3D),
      ryzen7950x3d: envOrArray(process.env.DISCORD_NOTIFY_GROUP_RYZEN7950X3D),
...
const store = {
  ...
  maxPrice: {
    series: {
      ...
      ryzen7900x3d: envOrNumber(process.env.MAX_PRICE_SERIES_RYZEN7900X3D),
      ryzen7950x3d: envOrNumber(process.env.MAX_PRICE_SERIES_RYZEN7950X3D),
