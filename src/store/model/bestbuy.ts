...
export const BestBuy: Store = {
	...
	links: [
		...
		},
		{
			...
			model: 'dual fan',
			series: '3060',
			url: 'https://www.bestbuy.com/site/pny-nvidia-geforce-rtx-3060-12gb-xlr8-gaming-revel-epic-x-rgb-dual-fan-graphics-card/6454319.p?cmp=RMX&skuId=6454319',
		},
		{
			brand: 'pny',
			...
			model: 'single fan',
			series: '3060',
			url: 'https://www.bestbuy.com/site/pny-nvidia-geforce-rtx-3060-12gb-xlr8-gaming-revel-epic-x-rgb-single-fan-graphics-card/6454318.p?cmp=RMX&skuId=6454318',
		}
	],
	name: 'bestbuy'
};