...
export const GameES: Store = {
  ...
  labels: {
    inStock: {
      container: '#body > div.main.container > div > div > section.right-side.product-quick-actions > div > h4 > span',
      text: ['Comprar'],
    },
    maxPrice: {
      container: '#body > div.main.container > div > div > section.right-side.product-quick-actions > div > div',
      euroFormat: true,
    },
    outOfStock: {
      container: '#body > div.main.container > div > div > section.right-side.product-quick-actions > div > h4 > span',
