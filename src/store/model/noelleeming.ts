  ...
  links: [
    {
      ...
      series: 'sonyps5c',
      url:
        'https://www.noelleeming.co.nz/prod192865.html',
    },
    {
      brand: 'sony',
      model: 'ps5 digital',
      series: 'sonyps5de',
      url:
        'https://www.noelleeming.co.nz/prod192879.html',
    },
    {
      brand: 'microsoft',
      model: 'xbox series x',
      series: 'xboxsx',
      url:
        'https://www.noelleeming.co.nz/prod193770.html',
    },
    {
      brand: 'microsoft',
      model: 'xbox series s',
      series: 'xboxss',
      url:
        'https://www.noelleeming.co.nz/prod200475.html',
    }
  ],
  name: 'noelleeming',
};
