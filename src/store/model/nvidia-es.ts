...
export const NvidiaES: Store = {
  ...
  links: [
    ...
    },
    {
      ...
      series: '3070ti',
      url:
        'https://shop.nvidia.com/es-es/geforce/store/gpu/?page=1&limit=9&locale=es-es&category=GPU&gpu=RTX%203070%20Ti&manufacturer=NVIDIA&manufacturer_filter=NVIDIA~1,ACER~0,ASUS~0,EVGA~0,GAINWARD~0,GIGABYTE~1,HP~0,LENOVO~0,MSI~1,PALIT~1,PNY~2,ZOTAC~2',
    },
    {
      brand: 'nvidia',
      model: 'founders edition',
